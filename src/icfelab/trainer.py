...
from torch.nn import ConstantPad1d, TransformerEncoderLayer, TransformerEncoder
...
class TransformerTrainer(lightning.LightningModule):
    ...
    def __init__(self, model: TransformerEncoder, batch_size: int, hyper_parameters: dict) -> None:
        super().__init__()
        self.model = model
    ...
    def run_model(self, input: torch.Tensor, target: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor]:
        """
